...
public class NewsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Check if there is an existing v View (called convertView) that we can reuse,
        ...
        try {
            //localhash is a Variable of type HashMap<String,String>
        ...
        //Calling parseDateToddMMyyyy function to convert time in milliseconds to readable form
        String formattedDate = parseDateToddMMyyyy(resultDate);
        txt2.setText(formattedDate);
        if (formattedDate != null && !formattedDate.isEmpty()) {
            //Setting visibility of txt2 to visible if formattedDate is not null
            txt2.setVisibility(View.VISIBLE);
        }

        String section = localhash.get(res.getString(R.string.sectionName));
        txt3.setText(section);
        //Changing colour of each different section type block which is stored in textview txt3.
        ...
        } else if (section.equals(res.getString(R.string.basketball))) {
            txt3.setBackgroundColor(0xFFFF5722);
        ...
        //Using localhash2 variable of type HashMap<String, Drawable> and trying to pass image from website whose name is thumbnail.
        try {
